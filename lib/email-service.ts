...
const transporter = nodemailer.createTransport({
  ...
  secure: config.email.port === 465, // 465 portu genelde SSL için kullanılır
  auth: {
...
/**
 * Kullanıcı e-posta doğrulama maili gönderimi
 */
...
/**
 * Rezervasyon onay maili gönderimi
 */
...
/**
 * Rezervasyon hatırlatma maili gönderimi
 */
